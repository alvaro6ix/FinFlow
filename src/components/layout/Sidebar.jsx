...
import { 
  ...
  PieChart, Settings, Moon, Sun, LogOut, Zap, User, CreditCard // ✅ AGREGADO CreditCard
} from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  // ✅ AGREGADO: Ruta de Créditos debajo de Presupuestos
  const menuItems = [
    { path: '/dashboard', icon: <LayoutDashboard size={20} />, label: 'Dashboard' },
    { path: '/expenses', icon: <Wallet size={20} />, label: 'Gastos' },
    { path: '/budgets', icon: <Target size={20} />, label: 'Presupuestos' },
    { path: '/credits', icon: <CreditCard size={20} />, label: 'Créditos' }, // ✅ NUEVO
    { path: '/goals', icon: <Trophy size={20} />, label: 'Metas' },
    { path: '/recurring', icon: <Zap size={20} />, label: 'Suscripciones' },
